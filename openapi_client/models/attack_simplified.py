...
class AttackSimplified(BaseModel):
    ...
    attacker: Optional[AttackPlayerSimplified]
    ...
    __properties: ClassVar[List[str]] = ["id", "code", "started", "ended", "attacker", "defender", "result", "respect_gain", "respect_loss"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ended": obj.get("ended"),
            "attacker": AttackPlayerSimplified.from_dict(obj["attacker"]) if obj.get("attacker") is not None else None,
            "defender": AttackPlayerSimplified.from_dict(obj["defender"]) if obj.get("defender") is not None else None,
