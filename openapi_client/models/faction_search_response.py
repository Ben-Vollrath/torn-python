...
class FactionSearchResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "search": [FactionSearch.from_dict(_item) for _item in obj["search"]] if obj.get("search") is not None else None,
