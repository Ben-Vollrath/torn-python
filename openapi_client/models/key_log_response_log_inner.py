...
class KeyLogResponseLogInner(BaseModel):
    """
    KeyLogResponseLogInner
    """ # noqa: E501
    timestamp: StrictInt
    type: StrictStr
    selections: StrictStr
    id: Optional[KeyLogResponseLogInnerId]
    comment: Optional[StrictStr] = None
    ip: StrictStr
    __properties: ClassVar[List[str]] = ["timestamp", "type", "selections", "id", "comment", "ip"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": KeyLogResponseLogInnerId.from_dict(obj["id"]) if obj.get("id") is not None else None,
