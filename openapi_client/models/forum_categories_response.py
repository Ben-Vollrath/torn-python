...
class ForumCategoriesResponse(BaseModel):
    ...
    """ # noqa: E501
    categories: List[ForumCategoriesResponseCategoriesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "categories": [ForumCategoriesResponseCategoriesInner.from_dict(_item) for _item in obj["categories"]] if obj.get("categories") is not None else None
        })
        return _obj
