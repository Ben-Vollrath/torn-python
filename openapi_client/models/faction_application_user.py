...
class FactionApplicationUser(BaseModel):
    ...
    name: StrictStr
    level: StrictInt
    stats: Optional[FactionApplicationUserStats]
    __properties: ClassVar[List[str]] = ["id", "name", "level", "stats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "level": obj.get("level"),
            "stats": FactionApplicationUserStats.from_dict(obj["stats"]) if obj.get("stats") is not None else None
        })
        return _obj
