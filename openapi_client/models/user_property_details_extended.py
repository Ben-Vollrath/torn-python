...
class UserPropertyDetailsExtended(BaseModel):
    """
    ...
    status: StrictStr
    __properties: ClassVar[List[str]] = ["id", "owner", "property", "happy", "upkeep", "market_price", "modifications", "staff", "used_by", "status"]

    @field_validator('status')
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['none', 'in_use']):
            raise ValueError("must be one of enum values ('none', 'in_use')")
        return value
