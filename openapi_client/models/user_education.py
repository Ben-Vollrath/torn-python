...
class UserEducation(BaseModel):
    ...
    UserEducation
    """ # noqa: E501
    complete: List[StrictInt]
    current: Optional[UserCurrentEducation]
    __properties: ClassVar[List[str]] = ["complete", "current"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "current": UserCurrentEducation.from_dict(obj["current"]) if obj.get("current") is not None else None
        })
        return _obj
