...
class ForumSubscribedThread(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "forum_id", "author", "title", "posts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "title": obj.get("title"),
            "posts": ForumSubscribedThreadPostsCount.from_dict(obj["posts"]) if obj.get("posts") is not None else None
        })
        return _obj
