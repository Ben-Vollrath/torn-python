...
class PersonalStatsAttackingPublicAttackingFaction(BaseModel):
    """
    PersonalStatsAttackingPublicAttackingFaction
    """ # noqa: E501
    respect: StrictInt
    retaliations: StrictInt
    ranked_war_hits: StrictInt
    raid_hits: StrictInt
    territory: PersonalStatsAttackingPublicAttackingFactionTerritory
    __properties: ClassVar[List[str]] = ["respect", "retaliations", "ranked_war_hits", "raid_hits", "territory"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "retaliations": obj.get("retaliations"),
            "ranked_war_hits": obj.get("ranked_war_hits"),
            "raid_hits": obj.get("raid_hits"),
            "territory": PersonalStatsAttackingPublicAttackingFactionTerritory.from_dict(obj["territory"]) if obj.get("territory") is not None else None
        })
        return _obj
