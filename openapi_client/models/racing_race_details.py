...
class RacingRaceDetails(BaseModel):
    """
    RacingRaceDetails
    """ # noqa: E501
    id: StrictInt
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "track_id", "creator_id", "status", "laps", "participants", "schedule", "requirements", "is_official", "results"]
