...
class UserCrimeUniques(BaseModel):
    ...
    UserCrimeUniques
    """ # noqa: E501
    id: StrictInt = Field(description="Unique result id.")
    rewards: UserCrimeUniquesReward
    __properties: ClassVar[List[str]] = ["id", "rewards"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "rewards": UserCrimeUniquesReward.from_dict(obj["rewards"]) if obj.get("rewards") is not None else None
        })
        return _obj
