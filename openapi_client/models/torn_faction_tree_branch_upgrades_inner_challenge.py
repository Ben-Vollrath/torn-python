...
class TornFactionTreeBranchUpgradesInnerChallenge(BaseModel):
    """
    TornFactionTreeBranchUpgradesInnerChallenge
    """ # noqa: E501
    description: StrictStr
    amount_required: StrictInt
    stat: FactionStatEnum
    __properties: ClassVar[List[str]] = ["description", "amount_required", "stat"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "amount_required": obj.get("amount_required"),
            "stat": obj.get("stat")
        })
        return _obj
