...
class MarketPropertyDetails(BaseModel):
    """
    MarketPropertyDetails
    """ # noqa: E501
    listings: List[MarketPropertyDetailsListingsInner]
    var_property: BasicProperty = Field(alias="property")
    __properties: ClassVar[List[str]] = ["listings", "property"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "listings": [MarketPropertyDetailsListingsInner.from_dict(_item) for _item in obj["listings"]] if obj.get("listings") is not None else None,
