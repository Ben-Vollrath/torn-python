...
class ReportHistory(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["factions", "companies"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "factions": [ReportHistoryFaction.from_dict(_item) for _item in obj["factions"]] if obj.get("factions") is not None else None,
            "companies": [ReportHistoryCompany.from_dict(_item) for _item in obj["companies"]] if obj.get("companies") is not None else None
        })
        return _obj
