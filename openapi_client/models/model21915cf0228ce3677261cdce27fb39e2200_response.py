...
MODEL21915CF0228CE3677261CDCE27FB39E2200RESPONSE_ANY_OF_SCHEMAS = ["ForumCategoriesResponse", "ForumLookupResponse", "ForumPostsResponse", "ForumThreadResponse", "ForumThreadsResponse", "TimestampResponse"]

class Model21915cf0228ce3677261cdce27fb39e2200Response(BaseModel):
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = Model21915cf0228ce3677261cdce27fb39e2200Response.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Model21915cf0228ce3677261cdce27fb39e2200Response with anyOf schemas: ForumCategoriesResponse, ForumLookupResponse, ForumPostsResponse, ForumThreadResponse, ForumThreadsResponse, TimestampResponse. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Model21915cf0228ce3677261cdce27fb39e2200Response with anyOf schemas: ForumCategoriesResponse, ForumLookupResponse, ForumPostsResponse, ForumThreadResponse, ForumThreadsResponse, TimestampResponse. Details: " + ", ".join(error_messages))
        else:
            return instance
