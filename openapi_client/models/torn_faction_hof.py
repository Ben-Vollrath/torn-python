...
class TornFactionHof(BaseModel):
    ...
    members: StrictInt
    position: StrictInt
    rank: StrictStr = Field(description="The full rank title & division of the faction.")
    values: FactionHofValues
    __properties: ClassVar[List[str]] = ["id", "name", "members", "position", "rank", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rank": obj.get("rank"),
            "values": FactionHofValues.from_dict(obj["values"]) if obj.get("values") is not None else None
        })
        return _obj
