...
class FactionAttacksFullResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["attacks", "_metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attacks": [AttackSimplified.from_dict(_item) for _item in obj["attacks"]] if obj.get("attacks") is not None else None,
