...
class TornEducation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "courses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "courses": [TornEducationCourses.from_dict(_item) for _item in obj["courses"]] if obj.get("courses") is not None else None
        })
        return _obj
