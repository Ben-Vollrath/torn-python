...
class FactionRaidWarfare(BaseModel):
    """
    FactionRaidWarfare
    """ # noqa: E501
    id: StrictInt
    ...
    __properties: ClassVar[List[str]] = ["id", "start", "end", "aggressor", "defender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "start": obj.get("start"),
            "end": obj.get("end"),
            "aggressor": FactionRaidWarfareFaction.from_dict(obj["aggressor"]) if obj.get("aggressor") is not None else None,
            "defender": FactionRaidWarfareFaction.from_dict(obj["defender"]) if obj.get("defender") is not None else None
        })
        return _obj
