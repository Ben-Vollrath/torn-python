...
class RaceCarUpgrade(BaseModel):
    """
    RaceCarUpgrade
    """ # noqa: E501
    id: StrictInt
    ...
    __properties: ClassVar[List[str]] = ["id", "class_required", "name", "description", "category", "subcategory", "effects", "cost"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "class_required": obj.get("class_required"),
            "name": obj.get("name"),
            "description": obj.get("description"),
            "category": obj.get("category"),
            "subcategory": obj.get("subcategory"),
            "effects": RaceCarUpgradeEffects.from_dict(obj["effects"]) if obj.get("effects") is not None else None,
            "cost": RaceCarUpgradeCost.from_dict(obj["cost"]) if obj.get("cost") is not None else None
        })
        return _obj
