...
class PersonalStatsAttackingPublicAttackingHits(BaseModel):
    """
    ...
    miss: StrictInt
    critical: StrictInt
    one_hit_kills: StrictInt
    __properties: ClassVar[List[str]] = ["success", "miss", "critical", "one_hit_kills"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "one_hit_kills": obj.get("one_hit_kills")
        })
        return _obj
