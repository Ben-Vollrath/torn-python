...
class ForumThreadsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["threads", "_metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "threads": [ForumThreadBase.from_dict(_item) for _item in obj["threads"]] if obj.get("threads") is not None else None,
