...
class UserRacesResponse(BaseModel):
    """
    UserRacesResponse
    """ # noqa: E501
    races: List[RacingRaceDetails]
    metadata: RequestMetadataWithLinks = Field(alias="_metadata")
    __properties: ClassVar[List[str]] = ["races", "_metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "races": [RacingRaceDetails.from_dict(_item) for _item in obj["races"]] if obj.get("races") is not None else None,
