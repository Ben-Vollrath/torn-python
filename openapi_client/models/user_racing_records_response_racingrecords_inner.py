...
class UserRacingRecordsResponseRacingrecordsInner(BaseModel):
    """
    UserRacingRecordsResponseRacingrecordsInner
    """ # noqa: E501
    track: UserRacingRecordsResponseRacingrecordsInnerTrack
    records: List[UserRacingRecordsResponseRacingrecordsInnerRecordsInner]
    __properties: ClassVar[List[str]] = ["track", "records"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "track": UserRacingRecordsResponseRacingrecordsInnerTrack.from_dict(obj["track"]) if obj.get("track") is not None else None,
            "records": [UserRacingRecordsResponseRacingrecordsInnerRecordsInner.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
        return _obj
