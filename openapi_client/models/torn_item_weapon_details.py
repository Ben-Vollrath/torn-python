...
class TornItemWeaponDetails(BaseModel):
    ...
    """ # noqa: E501
    stealth_level: Union[StrictFloat, StrictInt]
    base_stats: TornItemBaseStats
    category: TornItemWeaponCategoryEnum
    ammo: Optional[TornItemWeaponDetailsAmmo]
    mods: List[StrictInt]
    __properties: ClassVar[List[str]] = ["stealth_level", "base_stats", "category", "ammo", "mods"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "stealth_level": obj.get("stealth_level"),
            "base_stats": TornItemBaseStats.from_dict(obj["base_stats"]) if obj.get("base_stats") is not None else None,
            "category": obj.get("category"),
            "ammo": TornItemWeaponDetailsAmmo.from_dict(obj["ammo"]) if obj.get("ammo") is not None else None,
            "mods": obj.get("mods")
        })
        return _obj
