...
class PersonalStatsAttackingPopularAttacking(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["attacks", "defends", "elo", "escapes", "killstreak", "hits", "damage", "networth", "ammunition", "faction"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attacks": PersonalStatsAttackingPopularAttackingAttacks.from_dict(obj["attacks"]) if obj.get("attacks") is not None else None,
            "defends": PersonalStatsAttackingPopularAttackingDefends.from_dict(obj["defends"]) if obj.get("defends") is not None else None,
            "elo": obj.get("elo"),
            ...
            "faction": PersonalStatsAttackingPopularAttackingFaction.from_dict(obj["faction"]) if obj.get("faction") is not None else None
        })
        return _obj
