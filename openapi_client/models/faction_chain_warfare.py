...
class FactionChainWarfare(BaseModel):
    """
    FactionChainWarfare
    """ # noqa: E501
    id: StrictInt
    ...
    faction: FactionChainWarfareAllOfFaction
    __properties: ClassVar[List[str]] = ["id", "chain", "respect", "start", "end", "faction"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "start": obj.get("start"),
            "end": obj.get("end"),
            "faction": FactionChainWarfareAllOfFaction.from_dict(obj["faction"]) if obj.get("faction") is not None else None
        })
        return _obj
