...
class FactionWarfareDirtyBombTargetFaction(BaseModel):
    """
    FactionWarfareDirtyBombTargetFaction
    """ # noqa: E501
    id: StrictInt
    name: StrictStr
    respect_lost: StrictInt
    __properties: ClassVar[List[str]] = ["id", "name", "respect_lost"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "respect_lost": obj.get("respect_lost")
        })
        return _obj
