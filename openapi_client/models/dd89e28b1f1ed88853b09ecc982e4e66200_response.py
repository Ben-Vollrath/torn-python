...
DD89E28B1F1ED88853B09ECC982E4E66200RESPONSE_ANY_OF_SCHEMAS = ["FactionApplicationsResponse", "FactionAttacksFullResponse", "FactionAttacksResponse", "FactionBalanceResponse", "FactionBasicResponse", "FactionChainReportResponse", "FactionChainsResponse", "FactionContributorsResponse", "FactionCrimeResponse", "FactionCrimesResponse", "FactionHofResponse", "FactionLookupResponse", "FactionMembersResponse", "FactionNewsResponse", "FactionOngoingChainResponse", "FactionPositionsResponse", "FactionRacketsResponse", "FactionRaidWarReportResponse", "FactionRaidsResponse", "FactionRankedWarReportResponse", "FactionRankedWarResponse", "FactionStatsResponse", "FactionTerritoriesOwnershipResponse", "FactionTerritoriesResponse", "FactionTerritoryWarReportResponse", "FactionTerritoryWarsHistoryResponse", "FactionTerritoryWarsResponse", "FactionUpgradesResponse", "FactionWarfareResponse", "FactionWarsResponse", "RevivesFullResponse", "RevivesResponse", "TimestampResponse"]

class Dd89e28b1f1ed88853b09ecc982e4e66200Response(BaseModel):
    """
    ...
    # data type: FactionRaidWarReportResponse
    anyof_schema_10_validator: Optional[FactionRaidWarReportResponse] = None
    # data type: FactionTerritoriesOwnershipResponse
    anyof_schema_11_validator: Optional[FactionTerritoriesOwnershipResponse] = None
    # data type: FactionPositionsResponse
    anyof_schema_12_validator: Optional[FactionPositionsResponse] = None
    # data type: RevivesFullResponse
    anyof_schema_13_validator: Optional[RevivesFullResponse] = None
    # data type: FactionAttacksFullResponse
    anyof_schema_14_validator: Optional[FactionAttacksFullResponse] = None
    # data type: FactionApplicationsResponse
    anyof_schema_15_validator: Optional[FactionApplicationsResponse] = None
    # data type: FactionOngoingChainResponse
    anyof_schema_16_validator: Optional[FactionOngoingChainResponse] = None
    # data type: FactionChainsResponse
    anyof_schema_17_validator: Optional[FactionChainsResponse] = None
    # data type: FactionChainReportResponse
    anyof_schema_18_validator: Optional[FactionChainReportResponse] = None
    # data type: FactionCrimesResponse
    anyof_schema_19_validator: Optional[FactionCrimesResponse] = None
    # data type: FactionCrimeResponse
    anyof_schema_20_validator: Optional[FactionCrimeResponse] = None
    # data type: FactionRaidsResponse
    anyof_schema_21_validator: Optional[FactionRaidsResponse] = None
    # data type: FactionWarfareResponse
    anyof_schema_22_validator: Optional[FactionWarfareResponse] = None
    # data type: FactionRankedWarReportResponse
    anyof_schema_23_validator: Optional[FactionRankedWarReportResponse] = None
    # data type: FactionTerritoryWarReportResponse
    anyof_schema_24_validator: Optional[FactionTerritoryWarReportResponse] = None
    # data type: FactionTerritoriesResponse
    anyof_schema_25_validator: Optional[FactionTerritoriesResponse] = None
    # data type: FactionUpgradesResponse
    anyof_schema_26_validator: Optional[FactionUpgradesResponse] = None
    # data type: FactionStatsResponse
    anyof_schema_27_validator: Optional[FactionStatsResponse] = None
    # data type: FactionTerritoryWarsResponse
    anyof_schema_28_validator: Optional[FactionTerritoryWarsResponse] = None
    # data type: FactionContributorsResponse
    anyof_schema_29_validator: Optional[FactionContributorsResponse] = None
    # data type: FactionRacketsResponse
    anyof_schema_30_validator: Optional[FactionRacketsResponse] = None
    # data type: FactionRankedWarResponse
    anyof_schema_31_validator: Optional[FactionRankedWarResponse] = None
    # data type: FactionLookupResponse
    anyof_schema_32_validator: Optional[FactionLookupResponse] = None
    # data type: TimestampResponse
    anyof_schema_33_validator: Optional[TimestampResponse] = None
    if TYPE_CHECKING:
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = Dd89e28b1f1ed88853b09ecc982e4e66200Response.model_construct()
        error_messages = []
        ...
        # validate data type: FactionRaidWarReportResponse
        if not isinstance(v, FactionRaidWarReportResponse):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FactionRaidWarReportResponse`")
        else:
            return v
        ...
        # validate data type: FactionRaidsResponse
        if not isinstance(v, FactionRaidsResponse):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FactionRaidsResponse`")
        else:
            return v

        # validate data type: FactionWarfareResponse
        if not isinstance(v, FactionWarfareResponse):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FactionWarfareResponse`")
        else:
            return v
        ...
        # validate data type: FactionTerritoriesResponse
        if not isinstance(v, FactionTerritoriesResponse):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FactionTerritoriesResponse`")
        else:
            return v
        ...
        # validate data type: FactionRacketsResponse
        if not isinstance(v, FactionRacketsResponse):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FactionRacketsResponse`")
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_10_validator: Optional[FactionRaidWarReportResponse] = None
        try:
            instance.actual_instance = FactionRaidWarReportResponse.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_11_validator: Optional[FactionTerritoriesOwnershipResponse] = None
        ...
        # anyof_schema_21_validator: Optional[FactionRaidsResponse] = None
        try:
            instance.actual_instance = FactionRaidsResponse.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_22_validator: Optional[FactionWarfareResponse] = None
        try:
            instance.actual_instance = FactionWarfareResponse.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_23_validator: Optional[FactionRankedWarReportResponse] = None
        ...
        # anyof_schema_25_validator: Optional[FactionTerritoriesResponse] = None
        try:
            instance.actual_instance = FactionTerritoriesResponse.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_26_validator: Optional[FactionUpgradesResponse] = None
        ...
        # anyof_schema_30_validator: Optional[FactionRacketsResponse] = None
        try:
            instance.actual_instance = FactionRacketsResponse.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_31_validator: Optional[FactionRankedWarResponse] = None
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Dd89e28b1f1ed88853b09ecc982e4e66200Response with anyOf schemas: FactionApplicationsResponse, FactionAttacksFullResponse, FactionAttacksResponse, FactionBalanceResponse, FactionBasicResponse, FactionChainReportResponse, FactionChainsResponse, FactionContributorsResponse, FactionCrimeResponse, FactionCrimesResponse, FactionHofResponse, FactionLookupResponse, FactionMembersResponse, FactionNewsResponse, FactionOngoingChainResponse, FactionPositionsResponse, FactionRacketsResponse, FactionRaidWarReportResponse, FactionRaidsResponse, FactionRankedWarReportResponse, FactionRankedWarResponse, FactionStatsResponse, FactionTerritoriesOwnershipResponse, FactionTerritoriesResponse, FactionTerritoryWarReportResponse, FactionTerritoryWarsHistoryResponse, FactionTerritoryWarsResponse, FactionUpgradesResponse, FactionWarfareResponse, FactionWarsResponse, RevivesFullResponse, RevivesResponse, TimestampResponse. Details: " + ", ".join(error_messages))
        else:
            return instance
