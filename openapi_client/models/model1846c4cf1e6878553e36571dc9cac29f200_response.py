...
MODEL1846C4CF1E6878553E36571DC9CAC29F200RESPONSE_ANY_OF_SCHEMAS = ["AttackLogResponse", "TimestampResponse", "TornBountiesResponse", "TornCalendarResponse", "TornCrimesResponse", "TornEducationResponse", "TornFactionHofResponse", "TornFactionTreeResponse", "TornHofResponse", "TornItemAmmoResponse", "TornItemModsResponse", "TornItemsResponse", "TornLogCategoriesResponse", "TornLogTypesResponse", "TornLookupResponse", "TornProperties", "TornSubcrimesResponse", "TornTerritoriesNoLinksResponse", "TornTerritoriesResponse"]

class Model1846c4cf1e6878553e36571dc9cac29f200Response(BaseModel):
    """
    ...
    # data type: TornProperties
    anyof_schema_12_validator: Optional[TornProperties] = None
    # data type: TornFactionTreeResponse
    anyof_schema_13_validator: Optional[TornFactionTreeResponse] = None
    # data type: AttackLogResponse
    anyof_schema_14_validator: Optional[AttackLogResponse] = None
    # data type: TornTerritoriesResponse
    anyof_schema_15_validator: Optional[TornTerritoriesResponse] = None
    # data type: TornTerritoriesNoLinksResponse
    anyof_schema_16_validator: Optional[TornTerritoriesNoLinksResponse] = None
    # data type: TornItemModsResponse
    anyof_schema_17_validator: Optional[TornItemModsResponse] = None
    # data type: TornLookupResponse
    anyof_schema_18_validator: Optional[TornLookupResponse] = None
    # data type: TimestampResponse
    anyof_schema_19_validator: Optional[TimestampResponse] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[AttackLogResponse, TimestampResponse, TornBountiesResponse, TornCalendarResponse, TornCrimesResponse, TornEducationResponse, TornFactionHofResponse, TornFactionTreeResponse, TornHofResponse, TornItemAmmoResponse, TornItemModsResponse, TornItemsResponse, TornLogCategoriesResponse, TornLogTypesResponse, TornLookupResponse, TornProperties, TornSubcrimesResponse, TornTerritoriesNoLinksResponse, TornTerritoriesResponse]] = None
    else:
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = Model1846c4cf1e6878553e36571dc9cac29f200Response.model_construct()
        error_messages = []
        ...
        # validate data type: TornProperties
        if not isinstance(v, TornProperties):
            error_messages.append(f"Error! Input type `{type(v)}` is not `TornProperties`")
        else:
            return v
        ...
        # validate data type: TornTerritoriesNoLinksResponse
        if not isinstance(v, TornTerritoriesNoLinksResponse):
            error_messages.append(f"Error! Input type `{type(v)}` is not `TornTerritoriesNoLinksResponse`")
        else:
            return v
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Model1846c4cf1e6878553e36571dc9cac29f200Response with anyOf schemas: AttackLogResponse, TimestampResponse, TornBountiesResponse, TornCalendarResponse, TornCrimesResponse, TornEducationResponse, TornFactionHofResponse, TornFactionTreeResponse, TornHofResponse, TornItemAmmoResponse, TornItemModsResponse, TornItemsResponse, TornLogCategoriesResponse, TornLogTypesResponse, TornLookupResponse, TornProperties, TornSubcrimesResponse, TornTerritoriesNoLinksResponse, TornTerritoriesResponse. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_12_validator: Optional[TornProperties] = None
        try:
            instance.actual_instance = TornProperties.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_13_validator: Optional[TornFactionTreeResponse] = None
        ...
        # anyof_schema_16_validator: Optional[TornTerritoriesNoLinksResponse] = None
        try:
            instance.actual_instance = TornTerritoriesNoLinksResponse.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_17_validator: Optional[TornItemModsResponse] = None
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Model1846c4cf1e6878553e36571dc9cac29f200Response with anyOf schemas: AttackLogResponse, TimestampResponse, TornBountiesResponse, TornCalendarResponse, TornCrimesResponse, TornEducationResponse, TornFactionHofResponse, TornFactionTreeResponse, TornHofResponse, TornItemAmmoResponse, TornItemModsResponse, TornItemsResponse, TornLogCategoriesResponse, TornLogTypesResponse, TornLookupResponse, TornProperties, TornSubcrimesResponse, TornTerritoriesNoLinksResponse, TornTerritoriesResponse. Details: " + ", ".join(error_messages))
        else:
            return instance
