...
class UserPropertiesResponse(BaseModel):
    ...
    """ # noqa: E501
    properties: List[UserPropertiesResponsePropertiesInner]
    metadata: RequestMetadataWithLinks = Field(alias="_metadata")
    __properties: ClassVar[List[str]] = ["properties", "_metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": [UserPropertiesResponsePropertiesInner.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None,
