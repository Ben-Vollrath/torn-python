...
CE480599312126B8A5D77CED3AB8CAA8CATPARAMETER_ONE_OF_SCHEMAS = ["PersonalStatsCategoryEnum", "RacingRaceTypeEnum", "ReportTypeEnum", "UserListEnum"]

class Ce480599312126b8a5d77ced3ab8caa8CatParameter(BaseModel):
    """
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = Ce480599312126b8a5d77ced3ab8caa8CatParameter.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in Ce480599312126b8a5d77ced3ab8caa8CatParameter with oneOf schemas: PersonalStatsCategoryEnum, RacingRaceTypeEnum, ReportTypeEnum, UserListEnum. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in Ce480599312126b8a5d77ced3ab8caa8CatParameter with oneOf schemas: PersonalStatsCategoryEnum, RacingRaceTypeEnum, ReportTypeEnum, UserListEnum. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into Ce480599312126b8a5d77ced3ab8caa8CatParameter with oneOf schemas: PersonalStatsCategoryEnum, RacingRaceTypeEnum, ReportTypeEnum, UserListEnum. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Ce480599312126b8a5d77ced3ab8caa8CatParameter with oneOf schemas: PersonalStatsCategoryEnum, RacingRaceTypeEnum, ReportTypeEnum, UserListEnum. Details: " + ", ".join(error_messages))
        else:
            return instance
