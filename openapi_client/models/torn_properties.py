...
class TornProperties(BaseModel):
    ...
    TornProperties
    """ # noqa: E501
    properties: Optional[List[TornPropertiesPropertiesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": [TornPropertiesPropertiesInner.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None
        })
        return _obj
