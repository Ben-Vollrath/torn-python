...
class FactionBalance(BaseModel):
    ...
    members: List[FactionBalanceMembersInner]
    __properties: ClassVar[List[str]] = ["faction", "members"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "faction": FactionBalanceFaction.from_dict(obj["faction"]) if obj.get("faction") is not None else None,
            "members": [FactionBalanceMembersInner.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None
        })
        return _obj
