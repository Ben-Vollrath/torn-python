...
class FactionNewsResponse(BaseModel):
    """
    FactionNewsResponse
    """ # noqa: E501
    news: List[FactionNews]
    metadata: RequestMetadataWithLinks = Field(alias="_metadata")
    __properties: ClassVar[List[str]] = ["news", "_metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "news": [FactionNews.from_dict(_item) for _item in obj["news"]] if obj.get("news") is not None else None,
