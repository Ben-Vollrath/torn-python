...
class FactionChainReportBonus(BaseModel):
    """
    FactionChainReportBonus
    """ # noqa: E501
    attacker_id: StrictInt
    defender_id: StrictInt
    chain: StrictInt
    respect: StrictInt
    __properties: ClassVar[List[str]] = ["attacker_id", "defender_id", "chain", "respect"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attacker_id": obj.get("attacker_id"),
