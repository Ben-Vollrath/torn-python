...
class PersonalStatsCommunicationCommunicationMailsSent(BaseModel):
    """
    ...
    friends: StrictInt
    faction: StrictInt
    colleagues: StrictInt
    spouse: StrictInt
    __properties: ClassVar[List[str]] = ["total", "friends", "faction", "colleagues", "spouse"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "colleagues": obj.get("colleagues"),
            "spouse": obj.get("spouse")
        })
        return _obj
