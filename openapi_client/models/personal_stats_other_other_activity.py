...
class PersonalStatsOtherOtherActivity(BaseModel):
    """
    PersonalStatsOtherOtherActivity
    """ # noqa: E501
    time: StrictInt = Field(description="Time played in seconds")
    streak: PersonalStatsOtherOtherActivityStreak
    __properties: ClassVar[List[str]] = ["time", "streak"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "time": obj.get("time"),
            "streak": PersonalStatsOtherOtherActivityStreak.from_dict(obj["streak"]) if obj.get("streak") is not None else None
        })
        return _obj
