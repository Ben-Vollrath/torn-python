...
class ForumPoll(BaseModel):
    ...
    """ # noqa: E501
    question: StrictStr
    answers_count: StrictInt
    answers: List[ForumPollVote]
    __properties: ClassVar[List[str]] = ["question", "answers_count", "answers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "answers_count": obj.get("answers_count"),
            "answers": [ForumPollVote.from_dict(_item) for _item in obj["answers"]] if obj.get("answers") is not None else None
        })
        return _obj
