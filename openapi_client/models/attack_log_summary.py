...
class AttackLogSummary(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt
    name: Optional[StrictStr] = Field(description="Name of the participant, could be null in stealthed attacks.")
    hits: StrictInt
    misses: StrictInt
    damage: StrictInt
    __properties: ClassVar[List[str]] = ["id", "name", "hits", "misses", "damage"]
