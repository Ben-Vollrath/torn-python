...
class FactionRaidReport(BaseModel):
    """
    FactionRaidReport
    """ # noqa: E501
    id: StrictInt
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "start": obj.get("start"),
            "end": obj.get("end"),
            "aggressor": FactionRaidReportFaction.from_dict(obj["aggressor"]) if obj.get("aggressor") is not None else None,
            "defender": FactionRaidReportFaction.from_dict(obj["defender"]) if obj.get("defender") is not None else None
        })
        return _obj
