...
class TornFactionTree(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "branches"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "branches": [TornFactionTreeBranch.from_dict(_item) for _item in obj["branches"]] if obj.get("branches") is not None else None
        })
        return _obj
