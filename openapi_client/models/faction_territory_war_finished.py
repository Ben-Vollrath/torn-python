...
class FactionTerritoryWarFinished(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "territory", "start", "end", "target", "result", "factions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "factions": [FactionTerritoryWarFinishedFaction.from_dict(_item) for _item in obj["factions"]] if obj.get("factions") is not None else None
        })
        return _obj
