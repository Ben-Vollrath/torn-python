...
class PersonalStatsInvestmentsInvestments(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["bank", "stocks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bank": PersonalStatsInvestmentsInvestmentsBank.from_dict(obj["bank"]) if obj.get("bank") is not None else None,
            "stocks": PersonalStatsInvestmentsInvestmentsStocks.from_dict(obj["stocks"]) if obj.get("stocks") is not None else None
        })
        return _obj
