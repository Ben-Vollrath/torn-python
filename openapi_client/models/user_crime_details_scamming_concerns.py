...
class UserCrimeDetailsScammingConcerns(BaseModel):
    ...
    attempts: StrictInt
    resolved: StrictInt
    __properties: ClassVar[List[str]] = ["attempts", "resolved"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attempts": obj.get("attempts") if obj.get("attempts") is not None else 0,
            "resolved": obj.get("resolved") if obj.get("resolved") is not None else 0
        })
        return _obj
