...
class FactionStatsResponse(BaseModel):
    """
    FactionStatsResponse
    """ # noqa: E501
    stats: List[FactionStat]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "stats": [FactionStat.from_dict(_item) for _item in obj["stats"]] if obj.get("stats") is not None else None
        })
        return _obj
