...
class FactionPositionsResponse(BaseModel):
    """
    FactionPositionsResponse
    """ # noqa: E501
    positions: List[FactionPosition]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "positions": [FactionPosition.from_dict(_item) for _item in obj["positions"]] if obj.get("positions") is not None else None
        })
        return _obj
