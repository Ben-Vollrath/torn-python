...
class FactionRankedWarReportResponseRankedwarreportFactionsInner(BaseModel):
    """
    ...
    score: StrictInt
    attacks: StrictInt
    rank: FactionRankedWarReportResponseRankedwarreportFactionsInnerRank
    rewards: FactionRankedWarReportResponseRankedwarreportFactionsInnerRewards
    members: List[FactionRankedWarReportResponseRankedwarreportFactionsInnerMembersInner]
    __properties: ClassVar[List[str]] = ["id", "name", "score", "attacks", "rank", "rewards", "members"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rank": FactionRankedWarReportResponseRankedwarreportFactionsInnerRank.from_dict(obj["rank"]) if obj.get("rank") is not None else None,
            "rewards": FactionRankedWarReportResponseRankedwarreportFactionsInnerRewards.from_dict(obj["rewards"]) if obj.get("rewards") is not None else None,
            "members": [FactionRankedWarReportResponseRankedwarreportFactionsInnerMembersInner.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None
        })
        return _obj
