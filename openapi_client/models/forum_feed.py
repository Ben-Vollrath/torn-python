...
class ForumFeed(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["thread_id", "post_id", "user", "title", "text", "timestamp", "is_seen", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user": ForumThreadAuthor.from_dict(obj["user"]) if obj.get("user") is not None else None,
            "title": obj.get("title"),
            "text": obj.get("text"),
