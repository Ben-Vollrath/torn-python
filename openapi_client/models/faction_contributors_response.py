...
class FactionContributorsResponse(BaseModel):
    """
    FactionContributorsResponse
    """ # noqa: E501
    contributors: List[FactionContributor]
    __properties: ClassVar[List[str]] = ["contributors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contributors": [FactionContributor.from_dict(_item) for _item in obj["contributors"]] if obj.get("contributors") is not None else None
        })
        return _obj
