...
class TornFactionTreeBranchUpgradesInner(BaseModel):
    """
    ...
    ability: StrictStr
    cost: StrictInt
    challenge: Optional[TornFactionTreeBranchUpgradesInnerChallenge]
    __properties: ClassVar[List[str]] = ["name", "level", "ability", "cost", "challenge"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cost": obj.get("cost"),
            "challenge": TornFactionTreeBranchUpgradesInnerChallenge.from_dict(obj["challenge"]) if obj.get("challenge") is not None else None
        })
        return _obj
