...
class RequestMetadataWithLinksAndTotal(BaseModel):
    """
    RequestMetadataWithLinksAndTotal
    """ # noqa: E501
    links: RequestLinks
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["links", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "links": RequestLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "total": obj.get("total")
        })
        return _obj
