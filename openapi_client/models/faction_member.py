...
class FactionMember(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "position", "level", "days_in_faction", "is_revivable", "is_on_wall", "is_in_oc", "has_early_discharge", "last_action", "status", "revive_setting"]
