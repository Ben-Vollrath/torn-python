...
class PersonalStatsInvestmentsInvestmentsStocks(BaseModel):
    """
    ...
    losses: StrictInt
    fees: StrictInt
    net_profits: StrictInt
    payouts: StrictInt
    __properties: ClassVar[List[str]] = ["profits", "losses", "fees", "net_profits", "payouts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "profits": obj.get("profits"),
            "losses": obj.get("losses"),
            "fees": obj.get("fees"),
            "net_profits": obj.get("net_profits"),
