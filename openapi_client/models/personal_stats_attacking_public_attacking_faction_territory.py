...
class PersonalStatsAttackingPublicAttackingFactionTerritory(BaseModel):
    """
    PersonalStatsAttackingPublicAttackingFactionTerritory
    """ # noqa: E501
    wall_joins: StrictInt
    wall_clears: StrictInt
    wall_time: StrictInt
    __properties: ClassVar[List[str]] = ["wall_joins", "wall_clears", "wall_time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "wall_joins": obj.get("wall_joins"),
            "wall_clears": obj.get("wall_clears"),
