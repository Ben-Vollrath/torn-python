...
class FactionLookupResponse(BaseModel):
    """
    FactionLookupResponse
    """ # noqa: E501
    selections: List[FactionSelectionName]
    __properties: ClassVar[List[str]] = ["selections"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "selections": [FactionSelectionName.from_dict(_item) for _item in obj["selections"]] if obj.get("selections") is not None else None
        })
        return _obj
