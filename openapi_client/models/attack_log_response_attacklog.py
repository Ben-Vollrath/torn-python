...
class AttackLogResponseAttacklog(BaseModel):
    """
    AttackLogResponseAttacklog
    """ # noqa: E501
    log: List[AttackLog]
    summary: List[AttackLogSummary]
    __properties: ClassVar[List[str]] = ["log", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "log": [AttackLog.from_dict(_item) for _item in obj["log"]] if obj.get("log") is not None else None,
            "summary": [AttackLogSummary.from_dict(_item) for _item in obj["summary"]] if obj.get("summary") is not None else None
        })
        return _obj
