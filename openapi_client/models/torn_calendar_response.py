...
class TornCalendarResponse(BaseModel):
    ...
    """ # noqa: E501
    calendar: TornCalendarResponseCalendar
    __properties: ClassVar[List[str]] = ["calendar"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "calendar": TornCalendarResponseCalendar.from_dict(obj["calendar"]) if obj.get("calendar") is not None else None
        })
        return _obj
