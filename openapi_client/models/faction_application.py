...
class FactionApplication(BaseModel):
    ...
    FactionApplication
    """ # noqa: E501
    id: StrictInt = Field(description="application id")
    user: FactionApplicationUser
    message: Optional[StrictStr]
    valid_until: StrictInt
    status: FactionApplicationStatusEnum
    __properties: ClassVar[List[str]] = ["id", "user", "message", "valid_until", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "user": FactionApplicationUser.from_dict(obj["user"]) if obj.get("user") is not None else None,
