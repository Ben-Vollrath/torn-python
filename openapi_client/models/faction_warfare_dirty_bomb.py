...
class FactionWarfareDirtyBomb(BaseModel):
    """
    FactionWarfareDirtyBomb
    """ # noqa: E501
    id: StrictInt
    planted_at: StrictInt
    detonated_at: StrictInt
    faction: FactionWarfareDirtyBombTargetFaction
    user: Optional[FactionWarfareDirtyBombPlanter]
    __properties: ClassVar[List[str]] = ["id", "planted_at", "detonated_at", "faction", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "planted_at": obj.get("planted_at"),
            "detonated_at": obj.get("detonated_at"),
            "faction": FactionWarfareDirtyBombTargetFaction.from_dict(obj["faction"]) if obj.get("faction") is not None else None,
            "user": FactionWarfareDirtyBombPlanter.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
