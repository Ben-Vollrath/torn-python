...
class AttackLogAttacker(BaseModel):
    """
    This value could be null in stealthed attacks.
    """ # noqa: E501
    id: StrictInt
    name: StrictStr
    item: Optional[AttackLogAttackerItem]
    __properties: ClassVar[List[str]] = ["id", "name", "item"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "item": AttackLogAttackerItem.from_dict(obj["item"]) if obj.get("item") is not None else None
        })
        return _obj
