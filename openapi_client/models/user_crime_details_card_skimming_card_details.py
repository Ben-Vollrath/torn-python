...
class UserCrimeDetailsCardSkimmingCardDetails(BaseModel):
    ...
    """ # noqa: E501
    recoverable: StrictInt
    recovered: StrictInt
    sold: StrictInt
    lost: StrictInt
    areas: List[UserCrimeDetailsCardSkimmingCardDetailsAreasInner]
    __properties: ClassVar[List[str]] = ["recoverable", "recovered", "sold", "lost", "areas"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sold": obj.get("sold"),
            "lost": obj.get("lost"),
            "areas": [UserCrimeDetailsCardSkimmingCardDetailsAreasInner.from_dict(_item) for _item in obj["areas"]] if obj.get("areas") is not None else None
        })
        return _obj
