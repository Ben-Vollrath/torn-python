...
class PersonalStatsAttackingPublicAttackingAttacks(BaseModel):
    """
    ...
    assist: StrictInt
    stealth: StrictInt
    __properties: ClassVar[List[str]] = ["won", "lost", "stalemate", "assist", "stealth"]
