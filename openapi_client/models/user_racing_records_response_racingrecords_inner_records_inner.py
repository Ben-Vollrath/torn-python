...
class UserRacingRecordsResponseRacingrecordsInnerRecordsInner(BaseModel):
    """
    ...
    car_name: StrictStr
    lap_time: StrictInt
    __properties: ClassVar[List[str]] = ["car_id", "car_name", "lap_time"]
