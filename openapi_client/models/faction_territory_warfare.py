...
class FactionTerritoryWarfare(BaseModel):
    """
    ...
    result: StrictStr
    __properties: ClassVar[List[str]] = ["id", "territory", "start", "end", "target", "aggressor", "defender", "result"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "aggressor": FactionTerritoryWarFaction.from_dict(obj["aggressor"]) if obj.get("aggressor") is not None else None,
            "defender": FactionTerritoryWarFaction.from_dict(obj["defender"]) if obj.get("defender") is not None else None,
