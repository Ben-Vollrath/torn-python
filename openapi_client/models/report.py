...
class Report(BaseModel):
    ...
    type: ReportTypeEnum
    target_id: StrictInt
    reporter_id: StrictInt
    faction_id: StrictInt
    timestamp: StrictInt
    report: ReportReportReport
    __properties: ClassVar[List[str]] = ["type", "target_id", "reporter_id", "faction_id", "timestamp", "report"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "report": ReportReportReport.from_dict(obj["report"]) if obj.get("report") is not None else None
        })
        return _obj
