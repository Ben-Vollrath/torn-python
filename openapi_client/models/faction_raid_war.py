...
class FactionRaidWar(BaseModel):
    """
    FactionRaidWar
    """ # noqa: E501
    war_id: StrictInt
    ...
    factions: List[FactionRaidWarParticipant] = Field(description="The factions involved in the raid war.")
    __properties: ClassVar[List[str]] = ["war_id", "start", "end", "factions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "start": obj.get("start"),
            "end": obj.get("end"),
            "factions": [FactionRaidWarParticipant.from_dict(_item) for _item in obj["factions"]] if obj.get("factions") is not None else None
        })
        return _obj
