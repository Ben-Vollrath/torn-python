...
class FactionTerritoryWar(BaseModel):
    """
    FactionTerritoryWar
    """ # noqa: E501
    war_id: StrictInt
    ...
    target: StrictInt = Field(description="The score target of the war.")
    winner: Optional[StrictInt] = None
    factions: List[FactionTerritoryWarParticipant] = Field(description="The factions involved in the territory war.")
    __properties: ClassVar[List[str]] = ["war_id", "territory", "start", "end", "target", "winner", "factions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "factions": [FactionTerritoryWarParticipant.from_dict(_item) for _item in obj["factions"]] if obj.get("factions") is not None else None
        })
        return _obj
