...
class PersonalStatsItemsPopularItems(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "found": PersonalStatsItemsPopularItemsFound.from_dict(obj["found"]) if obj.get("found") is not None else None,
