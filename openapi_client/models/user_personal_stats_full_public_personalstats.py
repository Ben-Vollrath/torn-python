...
class UserPersonalStatsFullPublicPersonalstats(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["attacking", "jobs", "trading", "jail", "hospital", "finishing_hits", "communication", "crimes", "bounties", "items", "travel", "drugs", "missions", "racing", "networth", "other"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attacking": PersonalStatsAttackingPublicAttacking.from_dict(obj["attacking"]) if obj.get("attacking") is not None else None,
