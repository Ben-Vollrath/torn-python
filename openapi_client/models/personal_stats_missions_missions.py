...
class PersonalStatsMissionsMissions(BaseModel):
    """
    ...
    credits: StrictInt
    __properties: ClassVar[List[str]] = ["missions", "contracts", "credits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "contracts": PersonalStatsMissionsMissionsContracts.from_dict(obj["contracts"]) if obj.get("contracts") is not None else None,
