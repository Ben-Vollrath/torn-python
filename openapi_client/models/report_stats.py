...
class ReportStats(BaseModel):
    ...
    dexterity: Optional[StrictInt]
    defense: Optional[StrictInt]
    total: Optional[StrictInt]
    __properties: ClassVar[List[str]] = ["strength", "speed", "dexterity", "defense", "total"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.dexterity is None and "dexterity" in self.model_fields_set:
