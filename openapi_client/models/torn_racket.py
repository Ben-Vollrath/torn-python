...
class TornRacket(BaseModel):
    ...
    changed_at: StrictInt
    __properties: ClassVar[List[str]] = ["name", "level", "description", "reward", "created_at", "changed_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reward": TornRacketReward.from_dict(obj["reward"]) if obj.get("reward") is not None else None,
