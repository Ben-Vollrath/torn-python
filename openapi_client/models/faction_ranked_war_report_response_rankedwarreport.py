...
class FactionRankedWarReportResponseRankedwarreport(BaseModel):
    """
    FactionRankedWarReportResponseRankedwarreport
    """ # noqa: E501
    id: StrictInt
    start: StrictInt = Field(description="Timestamp the war started at.")
    end: StrictInt = Field(description="Timestamp the war ended at.")
    winner: StrictInt
    forfeit: StrictBool
    factions: List[FactionRankedWarReportResponseRankedwarreportFactionsInner]
    __properties: ClassVar[List[str]] = ["id", "start", "end", "winner", "forfeit", "factions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "factions": [FactionRankedWarReportResponseRankedwarreportFactionsInner.from_dict(_item) for _item in obj["factions"]] if obj.get("factions") is not None else None
        })
        return _obj
