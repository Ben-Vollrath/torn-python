...
class TornFactionTreeBranch(BaseModel):
    ...
    id: StrictInt
    name: StrictStr
    upgrades: List[TornFactionTreeBranchUpgradesInner]
    __properties: ClassVar[List[str]] = ["id", "name", "upgrades"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "upgrades": [TornFactionTreeBranchUpgradesInner.from_dict(_item) for _item in obj["upgrades"]] if obj.get("upgrades") is not None else None
        })
        return _obj
