...
class TornEducationCourses(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "code", "name", "description", "duration", "rewards", "prerequisites"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rewards": TornEducationRewards.from_dict(obj["rewards"]) if obj.get("rewards") is not None else None,
            "prerequisites": TornEducationPrerequisites.from_dict(obj["prerequisites"]) if obj.get("prerequisites") is not None else None
        })
        return _obj
