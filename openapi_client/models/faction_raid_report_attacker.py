...
class FactionRaidReportAttacker(BaseModel):
    """
    FactionRaidReportAttacker
    """ # noqa: E501
    user: FactionRaidReportUser
    attacks: StrictInt
    damage: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["user", "attacks", "damage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user": FactionRaidReportUser.from_dict(obj["user"]) if obj.get("user") is not None else None,
