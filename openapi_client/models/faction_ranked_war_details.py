...
class FactionRankedWarDetails(BaseModel):
    """
    ...
    target: StrictInt
    winner: StrictInt
    factions: List[FactionRankedWarDetailsFactionsInner]
    __properties: ClassVar[List[str]] = ["id", "start", "end", "target", "winner", "factions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "factions": [FactionRankedWarDetailsFactionsInner.from_dict(_item) for _item in obj["factions"]] if obj.get("factions") is not None else None
        })
        return _obj
