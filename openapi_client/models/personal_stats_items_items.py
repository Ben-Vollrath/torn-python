...
class PersonalStatsItemsItems(BaseModel):
    """
    ...
    viruses_coded: StrictInt
    __properties: ClassVar[List[str]] = ["found", "trashed", "used", "viruses_coded"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "found": PersonalStatsItemsItemsFound.from_dict(obj["found"]) if obj.get("found") is not None else None,
            "trashed": obj.get("trashed"),
            "used": PersonalStatsItemsItemsUsed.from_dict(obj["used"]) if obj.get("used") is not None else None,
            "viruses_coded": obj.get("viruses_coded")
        })
        return _obj
