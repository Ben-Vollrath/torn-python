...
class FactionRankedWar(BaseModel):
    """
    FactionRankedWar
    """ # noqa: E501
    war_id: StrictInt
    ...
    winner: Optional[StrictInt]
    factions: List[FactionRankedWarParticipant] = Field(description="The factions involved in the ranked war.")
    __properties: ClassVar[List[str]] = ["war_id", "start", "end", "target", "winner", "factions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "factions": [FactionRankedWarParticipant.from_dict(_item) for _item in obj["factions"]] if obj.get("factions") is not None else None
        })
        return _obj
