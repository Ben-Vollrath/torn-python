...
class UserPropertyDetailsExtendedRented(BaseModel):
    """
    ...
    rental_period_remaining: StrictInt
    __properties: ClassVar[List[str]] = ["id", "owner", "property", "happy", "upkeep", "market_price", "modifications", "staff", "used_by", "status", "cost", "cost_per_day", "rental_period", "rental_period_remaining"]

    @field_validator('status')
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['rented']):
            raise ValueError("must be one of enum values ('rented')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rental_period_remaining": obj.get("rental_period_remaining")
        })
        return _obj
