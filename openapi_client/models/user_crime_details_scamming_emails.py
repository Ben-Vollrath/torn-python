...
class UserCrimeDetailsScammingEmails(BaseModel):
    ...
    scraper: StrictInt
    phisher: StrictInt
    __properties: ClassVar[List[str]] = ["scraper", "phisher"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "scraper": obj.get("scraper") if obj.get("scraper") is not None else 0,
            "phisher": obj.get("phisher") if obj.get("phisher") is not None else 0
        })
        return _obj
