...
class FactionTerritoryWarOngoing(BaseModel):
    """
    ...
    target: StrictInt
    factions: List[FactionTerritoryWarOngoingFaction]
    __properties: ClassVar[List[str]] = ["id", "territory", "start", "end", "target", "factions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "factions": [FactionTerritoryWarOngoingFaction.from_dict(_item) for _item in obj["factions"]] if obj.get("factions") is not None else None
        })
        return _obj
