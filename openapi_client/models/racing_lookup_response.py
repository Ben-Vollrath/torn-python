...
class RacingLookupResponse(BaseModel):
    """
    RacingLookupResponse
    """ # noqa: E501
    selections: List[RacingSelectionName]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "selections": [RacingSelectionName.from_dict(_item) for _item in obj["selections"]] if obj.get("selections") is not None else None
        })
        return _obj
