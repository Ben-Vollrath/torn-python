...
class FactionTerritoryWarParticipant(BaseModel):
    """
    ...
    name: StrictStr
    score: StrictInt
    chain: StrictInt = Field(description="Faction's current chain.")
    is_aggressor: StrictBool
    player_ids: List[StrictInt] = Field(alias="playerIds")
    __properties: ClassVar[List[str]] = ["id", "name", "score", "chain", "is_aggressor", "playerIds"]
