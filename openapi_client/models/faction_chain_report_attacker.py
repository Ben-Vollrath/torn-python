...
class FactionChainReportAttacker(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "respect", "attacks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "respect": FactionChainReportAttackerRespect.from_dict(obj["respect"]) if obj.get("respect") is not None else None,
            "attacks": FactionChainReportAttackerAttacks.from_dict(obj["attacks"]) if obj.get("attacks") is not None else None
        })
        return _obj
