...
class TornOrganizedCrime(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "difficulty", "spawn", "scope", "prerequisite", "slots"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of spawn
        if self.spawn:
            _dict['spawn'] = self.spawn.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spawn": TornOrganizedCrimeSpawn.from_dict(obj["spawn"]) if obj.get("spawn") is not None else None,
            "scope": TornOrganizedCrimeScope.from_dict(obj["scope"]) if obj.get("scope") is not None else None,
            "prerequisite": obj.get("prerequisite"),
            "slots": [TornOrganizedCrimeSlot.from_dict(_item) for _item in obj["slots"]] if obj.get("slots") is not None else None
        })
        return _obj
