...
class MarketRentalDetails(BaseModel):
    """
    MarketRentalDetails
    """ # noqa: E501
    listings: List[MarketRentalDetailsListingsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "listings": [MarketRentalDetailsListingsInner.from_dict(_item) for _item in obj["listings"]] if obj.get("listings") is not None else None,
