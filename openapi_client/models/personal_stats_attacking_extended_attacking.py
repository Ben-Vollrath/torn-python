...
class PersonalStatsAttackingExtendedAttacking(BaseModel):
    """
    ...
    killstreak: PersonalStatsOtherOtherActivityStreak
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "killstreak": PersonalStatsOtherOtherActivityStreak.from_dict(obj["killstreak"]) if obj.get("killstreak") is not None else None,
