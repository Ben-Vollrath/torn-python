...
class FactionChainsResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chains": [FactionChain.from_dict(_item) for _item in obj["chains"]] if obj.get("chains") is not None else None,
