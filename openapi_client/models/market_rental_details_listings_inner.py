...
class MarketRentalDetailsListingsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["happy", "cost", "cost_per_day", "rental_period", "market_price", "upkeep", "modifications"]
