...
class BazaarResponseSpecialized(BaseModel):
    """
    BazaarResponseSpecialized
    """ # noqa: E501
    bazaar: BazaarSpecialized
    __properties: ClassVar[List[str]] = ["bazaar"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bazaar": BazaarSpecialized.from_dict(obj["bazaar"]) if obj.get("bazaar") is not None else None
        })
        return _obj
