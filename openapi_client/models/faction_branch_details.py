...
class FactionBranchDetails(BaseModel):
    """
    FactionBranchDetails
    """ # noqa: E501
    name: StrictStr
    order: StrictInt
    multiplier: StrictInt = Field(description="Respect cost multiplier.")
    upgrades: List[FactionUpgradeDetails]
    __properties: ClassVar[List[str]] = ["name", "order", "multiplier", "upgrades"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "upgrades": [FactionUpgradeDetails.from_dict(_item) for _item in obj["upgrades"]] if obj.get("upgrades") is not None else None
        })
        return _obj
