...
class ItemMarketListingItemStats(BaseModel):
    """
    ItemMarketListingItemStats
    """ # noqa: E501
    damage: Optional[Union[StrictFloat, StrictInt]]
    accuracy: Optional[Union[StrictFloat, StrictInt]]
    armor: Optional[Union[StrictFloat, StrictInt]]
    quality: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["damage", "accuracy", "armor", "quality"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.damage is None and "damage" in self.model_fields_set:
            _dict['damage'] = None
