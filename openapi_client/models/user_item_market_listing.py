...
class UserItemMarketListing(BaseModel):
    """
    UserItemMarketListing
    """ # noqa: E501
    id: StrictInt
    price: StrictInt
    average_price: StrictInt
    amount: StrictInt
    is_anonymous: StrictBool
    available: StrictInt = Field(description="Amount remaining in the inventory.")
    item: UserItemMarkeListingItemDetails
    __properties: ClassVar[List[str]] = ["id", "price", "average_price", "amount", "is_anonymous", "available", "item"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "item": UserItemMarkeListingItemDetails.from_dict(obj["item"]) if obj.get("item") is not None else None
        })
        return _obj
