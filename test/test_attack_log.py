...
class TestAttackLog(unittest.TestCase):
    """AttackLog unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttackLog:
        """Test AttackLog
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttackLog`
        """
        model = AttackLog()
        if include_optional:
            return AttackLog(
