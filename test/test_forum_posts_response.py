...
class TestForumPostsResponse(unittest.TestCase):
    """ForumPostsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForumPostsResponse:
        """Test ForumPostsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForumPostsResponse`
        """
        model = ForumPostsResponse()
        if include_optional:
    ...
    def testForumPostsResponse(self):
        """Test ForumPostsResponse"""
