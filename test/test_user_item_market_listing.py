...
class TestUserItemMarketListing(unittest.TestCase):
    """UserItemMarketListing unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserItemMarketListing:
        """Test UserItemMarketListing
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserItemMarketListing`
        """
        model = UserItemMarketListing()
        if include_optional:
    ...
    def testUserItemMarketListing(self):
        """Test UserItemMarketListing"""
