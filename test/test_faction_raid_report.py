...
class TestFactionRaidReport(unittest.TestCase):
    """FactionRaidReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FactionRaidReport:
        """Test FactionRaidReport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FactionRaidReport`
        """
        model = FactionRaidReport()
        if include_optional:
    ...
    def testFactionRaidReport(self):
        """Test FactionRaidReport"""
