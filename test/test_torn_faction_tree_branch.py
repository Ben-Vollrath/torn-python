...
class TestTornFactionTreeBranch(unittest.TestCase):
    """TornFactionTreeBranch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TornFactionTreeBranch:
        """Test TornFactionTreeBranch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TornFactionTreeBranch`
        """
        model = TornFactionTreeBranch()
        if include_optional:
    ...
    def testTornFactionTreeBranch(self):
        """Test TornFactionTreeBranch"""
