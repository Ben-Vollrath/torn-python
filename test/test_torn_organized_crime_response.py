...
class TestTornOrganizedCrimeResponse(unittest.TestCase):
    """TornOrganizedCrimeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TornOrganizedCrimeResponse:
        """Test TornOrganizedCrimeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TornOrganizedCrimeResponse`
        """
        model = TornOrganizedCrimeResponse()
        if include_optional:
            return TornOrganizedCrimeResponse(
                organizedcrimes = [
                    openapi_client.models.torn_organized_crime.TornOrganizedCrime(
                        name = '', 
                        description = '', 
                        difficulty = 56, 
    ...
    def testTornOrganizedCrimeResponse(self):
        """Test TornOrganizedCrimeResponse"""
