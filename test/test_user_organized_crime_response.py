...
class TestUserOrganizedCrimeResponse(unittest.TestCase):
    """UserOrganizedCrimeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserOrganizedCrimeResponse:
        """Test UserOrganizedCrimeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserOrganizedCrimeResponse`
        """
        model = UserOrganizedCrimeResponse()
        if include_optional:
    ...
    def testUserOrganizedCrimeResponse(self):
        """Test UserOrganizedCrimeResponse"""
