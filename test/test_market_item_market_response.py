...
class TestMarketItemMarketResponse(unittest.TestCase):
    """MarketItemMarketResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarketItemMarketResponse:
        """Test MarketItemMarketResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarketItemMarketResponse`
        """
        model = MarketItemMarketResponse()
        if include_optional:
    ...
    def testMarketItemMarketResponse(self):
        """Test MarketItemMarketResponse"""
