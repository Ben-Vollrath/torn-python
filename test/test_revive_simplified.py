...
class TestReviveSimplified(unittest.TestCase):
    """ReviveSimplified unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviveSimplified:
        """Test ReviveSimplified
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviveSimplified`
        """
        model = ReviveSimplified()
        if include_optional:
