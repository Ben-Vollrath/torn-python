...
class TestTornTerritoriesResponse(unittest.TestCase):
    """TornTerritoriesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TornTerritoriesResponse:
        """Test TornTerritoriesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TornTerritoriesResponse`
        """
        model = TornTerritoriesResponse()
        if include_optional:
    ...
    def testTornTerritoriesResponse(self):
        """Test TornTerritoriesResponse"""
