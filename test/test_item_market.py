...
class TestItemMarket(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ItemMarket:
        """Test ItemMarket
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemMarket`
        """
        model = ItemMarket()
        if include_optional:
            return ItemMarket(
