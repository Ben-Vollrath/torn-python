...
class TestFactionRaidReportFaction(unittest.TestCase):
    """FactionRaidReportFaction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FactionRaidReportFaction:
        """Test FactionRaidReportFaction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FactionRaidReportFaction`
        """
        model = FactionRaidReportFaction()
        if include_optional:
    ...
    def testFactionRaidReportFaction(self):
        """Test FactionRaidReportFaction"""
