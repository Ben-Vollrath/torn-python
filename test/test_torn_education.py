...
class TestTornEducation(unittest.TestCase):
    """TornEducation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TornEducation:
        """Test TornEducation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TornEducation`
        """
        model = TornEducation()
        if include_optional:
