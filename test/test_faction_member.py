...
class TestFactionMember(unittest.TestCase):
    """FactionMember unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FactionMember:
        """Test FactionMember
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FactionMember`
        """
        model = FactionMember()
        if include_optional:
