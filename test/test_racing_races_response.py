...
class TestRacingRacesResponse(unittest.TestCase):
    """RacingRacesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RacingRacesResponse:
        """Test RacingRacesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RacingRacesResponse`
        """
        model = RacingRacesResponse()
        if include_optional:
    ...
    def testRacingRacesResponse(self):
        """Test RacingRacesResponse"""
