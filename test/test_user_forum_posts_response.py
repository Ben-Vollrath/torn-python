...
class TestUserForumPostsResponse(unittest.TestCase):
    """UserForumPostsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserForumPostsResponse:
        """Test UserForumPostsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserForumPostsResponse`
        """
        model = UserForumPostsResponse()
        if include_optional:
    ...
    def testUserForumPostsResponse(self):
        """Test UserForumPostsResponse"""
