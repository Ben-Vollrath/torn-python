...
class TestTornEducationCourses(unittest.TestCase):
    """TornEducationCourses unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TornEducationCourses:
        """Test TornEducationCourses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TornEducationCourses`
        """
        model = TornEducationCourses()
        if include_optional:
    ...
    def testTornEducationCourses(self):
        """Test TornEducationCourses"""
