...
class TestRacingRaceDetails(unittest.TestCase):
    """RacingRaceDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RacingRaceDetails:
        """Test RacingRaceDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RacingRaceDetails`
        """
        model = RacingRaceDetails()
        if include_optional:
            return RacingRaceDetails(
                ...
                is_official = True,
                results = [
                    openapi_client.models.racer_details.RacerDetails(
                        driver_id = 56, 
                        position = 56, 
                        car_id = 56, 
                        car_item_id = 56, 
    ...
    def testRacingRaceDetails(self):
        """Test RacingRaceDetails"""
