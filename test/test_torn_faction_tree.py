...
class TestTornFactionTree(unittest.TestCase):
    """TornFactionTree unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TornFactionTree:
        """Test TornFactionTree
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TornFactionTree`
        """
        model = TornFactionTree()
        if include_optional:
