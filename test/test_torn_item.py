...
class TestTornItem(unittest.TestCase):
    """TornItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TornItem:
        """Test TornItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TornItem`
        """
        model = TornItem()
        if include_optional:
            return TornItem(
