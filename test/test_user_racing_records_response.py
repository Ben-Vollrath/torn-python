...
class TestUserRacingRecordsResponse(unittest.TestCase):
    """UserRacingRecordsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserRacingRecordsResponse:
        """Test UserRacingRecordsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserRacingRecordsResponse`
        """
        model = UserRacingRecordsResponse()
        if include_optional:
    ...
    def testUserRacingRecordsResponse(self):
        """Test UserRacingRecordsResponse"""
