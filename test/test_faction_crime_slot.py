...
class TestFactionCrimeSlot(unittest.TestCase):
    """FactionCrimeSlot unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FactionCrimeSlot:
        """Test FactionCrimeSlot
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FactionCrimeSlot`
        """
        model = FactionCrimeSlot()
        if include_optional:
